...
# getwd()
path = 'svm_smn/Simulacao/Estudos_Simulacao/ts/hmc/theta/dual/dual_hmc.cpp'
Rcpp::sourceCpp( path )
...
N = 2e1
samples = hmc_svm_t(N,
                    eps_theta = 0.001, M_theta,
                    delta = 0.65, lambda = 0.01, M_adapt = 0.5 * N, 
                    h = h,
                    y_T = c(0, y), 
                    seed = 0 
                    )
