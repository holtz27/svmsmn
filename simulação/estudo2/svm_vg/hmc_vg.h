#ifndef HMC_VG_H_INCLUDED
#define HMC_VG_H_INCLUDED
...
// Metrics
// hmc updates
vec hmc_theta(vec theta_cur, vec h, int L, double eps, int T, int &acc, int &cont, mat inv_M, int k, double prec);
...
// hmc update
vec hmc_b(vec b_cur, vec h, vec l, int L, double eps, int T, vec y_T, int &acc, int &cont, mat inv_M, int k, double prec);
...
// hmc update
double hmc_v(double e_cur, vec l, int L, double eps, int T, int &acc, double alpha, double li, double ls, double inv_M, int &cont, int k, double prec);
