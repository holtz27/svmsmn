...
par( mfrow = c(1, 7) )
# hmc
boxplot( as.numeric( Data$hmc_eff[1, ] / Data$hmc_times[ 1 ] ), xlab = expression(mu), ylab = 'eff/s' )
...
par( mfrow = c(1, 7) )
# rmhmc
boxplot( as.numeric( Data$rmhmc_eff[1, ] / Data$rmhmc_times[ 1 ] ), xlab = expression(mu), ylab = 'eff/s' )
