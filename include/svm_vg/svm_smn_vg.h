#ifndef SVM_SMN_VG_H_INCLUDED
#define SVM_SMN_VG_H_INCLUDED
...
// hmc update
vec hmc_l(vec z_cur, double e, vec b, vec l, int L, double eps, int T, vec y_T, int &acc, double alpha, double li, double ls);
